...
import { useQueryBookmarksByTag } from "../../hooks/useQueryBookmarksByTag";

export const TagSearchResultList: React.FC = () => {
  const { data, hasNextPage, query, onClickHandler } = useQueryBookmarksByTag();
